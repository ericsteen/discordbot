...
ffmpegopts = {
    'before_options': '-reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5 -nostdin -err_detect ignore_err',
    'verbose': True,
...
class YTDLSource(discord.PCMVolumeTransformer):
    ...
    async def create_source(cls, ctx, search: str, *, loop, download=False):
        ...
        return cls(discord.FFmpegPCMAudio(source), data=data, requester=ctx.author, options=ffmpegopts)
